...
public class UserSearchController extends HttpServlet {
    ...
    private static final String IN = "user.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (name.length() > 0 && (categoryID == null||categoryID.equals("")) && min.length() == 0) {//search by Name
                List<ProductDTO> result = beans.searchByName();
                request.setAttribute("INFO", result);
            } else if (min.length() > 0 && name.length() == 0 && (categoryID == null||categoryID.equals(""))) {//search by Prices
                ...
                request.setAttribute("INFO", result);
            } else if (name.length() > 0 && min.length() > 0 && (categoryID == null||categoryID.equals(""))) {// search by Name and Prices
                beans.setMin(Float.parseFloat(min));
                beans.setMax(Float.parseFloat(max));
